...
from vermon import __version__
from vermon import __author__
from vermon import __email__
from vermon import __project_github__
...
setup(
    name='vermon',
    version=__version__,
    description='Check for a newer version of your package and notify the user about it',
    long_description=long_description,
    long_description_content_type='text/markdown',
    license='MIT License',
    author=__author__,
    author_email=__email__,
    url=__project_github__,
    ...
    python_requires='>=3.6',
    project_urls={
        "Bug Tracker": "https://github.com/matheusfelipeog/vermon/issues",
        "Documentation": __project_github__,
        "Source Code": __project_github__,
    },
    keywords=[
        'vermon', 'version-monitoring', 'version-check', 'vermon-package',
        'version-newer', 'package-monitoring', 'notify'
    ],
    classifiers=[
